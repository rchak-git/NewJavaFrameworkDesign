/*
ARCHIVED: This class is no longer part of the active Round2 execution flow.
It has been moved to the archived package to keep active packages clean.

Original purpose:
- context-aware normalization of POPULATE / VERIFY / ACTION steps

Replacement:
- rajib.automation.framework.v3.round2.utils.StepConverters
*/

package rajib.automation.framework.v3.round2.archived;
