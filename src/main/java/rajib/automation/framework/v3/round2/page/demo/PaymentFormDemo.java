package rajib.automation.framework.v3.round2.page.demo;
...
public class PaymentFormDemo extends BasePageR2 {
    ...
    public PaymentFormDemo(ElementResolver resolver, RuntimeContext runtimeContext) {
